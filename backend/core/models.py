...
class Rule(BaseModel):
    ...
    is_completed: bool = Field(default=False, description="Whether the rule is completed")
...
class ChallengeLLMResponse(BaseModel):
    ...
    is_completed: bool = Field(default=False, description="Whether the challenge is completed")